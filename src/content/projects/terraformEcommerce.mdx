...
<div class="flex gap-4 pt-5 items-center">
  ...
  <div class="popUp flex justify-center items-center flex-col">
    <a href='https://github.com/ajosemoya/E-commerce-Terraform-C' target="_blank">
        <img
            src='/images/github-icon.webp'
            alt='GitHub'
            width={100}
...
![Diagrama Arquitectónico del Proyecto Terraform 2025](/images/projects/terraform.webp)
